...
const SeeMore = ({ title, detail, ac, i }) => {
    // const active = () => {
    //     console.log(i, ac)
    ...
    return (
        <div className='flex flex-col gap-3'>
            <div className='flex flex-row text-[16px] text-black md:text-[25px] items-center gap-2 font-bold font-DMSans w-max cursor-pointer' onClick={() => {
                setShow(!show)
