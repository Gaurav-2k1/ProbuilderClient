    ...
    return (
        <div className='absolute top-10 right-0
          z-50 delay-110 transition-all ease-linear'>
            <div className='flex flex-col  overflow-y-auto p-2 bg-white min-h-[100px] max-h-[40vh]'>
...
const TemplateBox = ({ url, link }) => {
    ...
    return (
        <div className={`w-[300px] h-[200px] border-lg my-4  delay-110 ease-in transition-all cursor-pointer relative ${template === link ? "border-4 border-icob  border-solid":""}`}
            ...
            <p className='bg-white text-black rounded-2xl px-3 py-1 absolute top-1/2 left-[40%] hidden group-hover:block delay-110 transition-all ease-in'>use </p>
        </div>
    )
}
