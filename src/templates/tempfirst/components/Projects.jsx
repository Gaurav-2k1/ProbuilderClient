...
const Projects = ({ user }) => {
  return (
    <>
      <section className='flex flex-col w-full h-full md:px-32 md:pt-10' id="project">
        <p className=' headings'>Projects i built with a motive</p>
        ...
        <div
          className='flex flex-wrap mt-10 gap-6 justify-items-center'>
          {
